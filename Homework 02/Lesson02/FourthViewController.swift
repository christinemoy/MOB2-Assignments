...
*/
    ...
    @IBAction func doMath(sender: AnyObject) {
        let inputNumber = input.text!.toInt()!
        
        let fibCalculator = FibAdder()
        output.text = String(fibCalculator.fibRecursive(inputNumber))
